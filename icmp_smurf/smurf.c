...
int main(int argc, char **argv)
{
  ...
  protocol_tag = libnet_build_ipv4(LIBNET_IPV4_H + LIBNET_ICMPV4_ECHO_H + payload_length, 0, 10, 0, 20, IPPROTO_ICMP, 0, source_ip, destination_ip, payload, payload_length, l, 0);
  while (1)
  {
